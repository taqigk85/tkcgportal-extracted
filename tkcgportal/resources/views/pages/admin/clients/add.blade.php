    ...
    <div class="flex justify-between items-center pb-5 mt-14">
            <div class="list-header">
                <div class="flex items-center justify-start">
                    ...
                    <h2 class="font-normal text-2xl">Add New Client</h2>
                </div>
            </div>
    </div>

    <div class="w-full p-8 bg-white rounded-md">
        <form action="{{route('admin.client.add.post')}}" method="post" class="flex flex-col"
            ...
            <div class="basic-information">
                ...
                <div class="input-group w-full mb-4 image-exist">
                ...
                <div class="flex justify-between gap-[10px]">
                   ...
                   <div class="input-group w-1/2 mb-4">
                        ...
                        <input type="text" name="name" id="name" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none required_fields" value="{{old('name')}}"
                   ...
                   <div class="input-group w-1/2 mb-4">
                        ...
                        value="{{old('mobile')}}" data-error-msg="Mobile is required" />
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
                ...
                <div class="flex justify-between gap-[10px]">
                    ...
                    <div class="input-group w-1/2 mb-4">
                        ...
                        value="{{ old('email') }}" data-error-msg="Email is required" />
                        <span class="scrollForReq error-message"></span>
                    </div>
                </div>
            </div>
            ...
            <div class="address-information">
                ...
                <div class="flex justify-between gap-[10px]">
                    ...
                    <div class="input-group w-1/2 mb-4">
                        ...
                        <input type="text" name="street_name" id="street_name" class="w-full p-3 border border-gray-300 rounded-md text-base text-gray-700 outline-none" value="{{ old('street_name') }}" />
                    </div>
         ...
         <div class="w-full">
            <!-- Submit Button -->
            <button type="submit" class="p-[0.95rem] bg-gray-700 text-white text-base border-none rounded-md cursor-pointer transition-all duration-300 mt-4 mb-4 w-full uppercase">Submit</button>
        </div>
        </form>
    </div>
</div>

...
<div class="flex justify-between items-center mt-[60px] pb-[20px]">
    ...
    <div class="list-header">
        <div class="flex items-center justify-start">
            <a href="{{route('admin.project.list')}}" class="p-1 inline-flex"><img src="{{asset('/public/images/arrow.svg')}}" alt="Back Button" class="w-4"></a>
...
<script>
    var storeTableDataUrl = "{{ route('admin.store.table_data') }}";
    var downloadPdfUrl = "{{ route('admin.download.pdf', $project->id) }}";
